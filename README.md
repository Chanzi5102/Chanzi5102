...
Software Engineer | Automotive & Systems Specialist
...
**$ Integrating computer vision into the cockpit for driver safety.
    ...
    Highlights: Real-time drowsiness detection using facial landmark tracking.
...
**$ Performance Metrics (The "Professor" Mindset)
    ...
    Code Review Standard: Clean Code / SOLID Principles
